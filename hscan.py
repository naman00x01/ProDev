...
for port in open_ports:
    if port in port_info:
        ...
        try:
            ...
            print(f"🢂 {Fore.CYAN}Port: {port} | Service: {info.get('Service', 'N/A')} | Protocol: {info.get('Protocol', 'N/A')} | Description: N/A{Style.RESET_ALL}\n")
